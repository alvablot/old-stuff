...
<body>
	...
	mysql_select_db("alvablot_com", $connection) or die("Kunde inte v�lja databas");
	$hamta = "SELECT * FROM spel ORDER BY poang DESC";
	$resultat = mysql_query($hamta) or die("Det gick inte att h�mta information fr�n databasen!");

	$i = 1;
	print "<h3>TIO I TOPP</h3>";
	print '<table bgcolor=#999999 width=350 cellpadding=2 cellspacing=1><tr bgcolor=#cccccc><td><b class=blue>Rank</b></td><td><b class=blue>Namn</b></td><td><b class=blue>Po�ng</b></td><td><b class=blue>Niv�</b></td></tr>';
	...
	print "<br>Spelet har spelats " . ($i) .  " g�nger";
	?>
	<br><br>
